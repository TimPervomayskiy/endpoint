...
## 5. Реализвать ci/cd процесс при помощи github actions
...
## 6. Реализовать модель мониторинга Node Exporter + Prometheus + Grafana для приложения

- ##### Модель должна быть установлена при помощи Helm в отдельный kubernetes namespace

## 7. Найти и реализовать возможность нотификации о падении приложения в канал telegram, основанную на проверке кода состояния HTTP
